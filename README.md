# Project 3 - *purplebird*

**Purplebird** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x] User can **open the twitter app offline and see last loaded tweets**. Persisted in 'a FILE' ~~SQLite~~ tweets are refreshed on every application launch. While "live data" is displayed when app can get it from Twitter API, it is also saved for use in offline mode.
...
Dealing with the API Rate Limit during development and testing. Used Offline mode to get around this challenge
