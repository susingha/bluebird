...
* [x] User can **open the twitter app offline and see last loaded tweets**. Persisted in ~~~SQLite~~~ File tweets are refreshed on every application launch. While "live data" is displayed when app can get it from Twitter API, it is also saved for use in offline mode.
